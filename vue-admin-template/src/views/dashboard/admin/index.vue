...
export default {
  ...
  created() {
    ...
    this.countriesHARD = [
      ...
      { name: 'Agile Tracking Solutions', country: 'Saudi Arabia' },
      ...
      { name: 'Borderless', country: 'Angola' },
      ...
      { name: 'Cloudnet', country: 'United Arab Emirates' },
      ...
      { name: 'Fox Electronics', country: 'Congo' },
      ...
      { name: 'Staywired Solutions', country: 'Nigeria' },
        ...
        response.data.every((element, index) => {
          ...
          if (index < response.data.length - 1) return true
            ...
            if (this.mapLoading){
              ...
              colors['bw'] =  'rgb(46, 199, 201)'
              colors['zw'] =  'rgb(46, 199, 201)'
              colors['ao'] =  'rgb(46, 199, 201)'
              colors['ng'] =  'rgb(46, 199, 201)'
              colors['sa'] =  'rgb(46, 199, 201)'
              colors['ae'] =  'rgb(46, 199, 201)'
